...
config_files_bspline_extraobjectsenv_l = [
    ...
    ("./cfgs/config_EnvCoblEmpty2D-RobotPointMass2DBig_comp_v2.yaml", "EnvCobl2D"),
]
...
# trajectory_duration = 2.8 # ncomp 4
# trajectory_duration = 3.5  # ncomp 3# sml trajectory duration
trajectory_duration = 4.9 # ncomp 2 
...
network_config_l = [
    ...
    OrderedDict(guide_mode__ = "hybrid",
                ...
                condition_guidance_g__ = 0.5, #0.5,
                # lambda_l__ = 1.0,
                # lambda_g__ = 0.5,
                ),
    # OrderedDict(guide_mode__ = "hybrid",
