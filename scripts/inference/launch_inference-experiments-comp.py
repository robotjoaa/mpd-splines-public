...
config_files_bspline_extraobjectsenv_l = [
    ...
    #("./cfgs/config_EnvSimple2D-RobotPointMass2D_comp.yaml", "EnvDynSimple2DExtraObjects"),
    ("./cfgs/config_EnvSimple2D-RobotPointMass2D_comp.yaml", "EnvSimple2DExtraObjectsV00"),
