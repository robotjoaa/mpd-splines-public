...
single_experiment_params_base_l = [
    ...
    OrderedDict(
        ...
        context_qs__=False, # fixed for hard conds
        context_ee_goal_pose__=False, # fixed for hard conds
        batch_size = 192, # should be dividied by 3 
        ...
        bspline_num_control_points_desired__=28, # to make it 24 + 2 / 24 + 6
    ),
]
...
dataset_file_merged_l = [
    OrderedDict(dataset_file_merged__="dataset_merged_doubled_comp_segments.hdf5"),
]

network_config_l = [
    OrderedDict(guide_mode__ = "cfg",
                len_ovlp_cd__ = 6,
                use_end_ovlp_model__ = False,
...
for single_experiment_params_base, parametric_trajectory_class, dataset_file_merged, network_config in product(
    single_experiment_params_base_l, parametric_trajectory_class_l, dataset_file_merged_l, network_config_l 
):
    ...
    single_experiment_params.update(network_config)
...
for single_experiment_params in single_experiment_params_l:
    ...
    launcher.add_experiment(
        generative_model_class__="CompDiffusionModelv2",
        **single_experiment_params,
        ...
        clip_grad=True,
        use_ema=True,
        summary_class="SummaryCompDiffuserV2",
