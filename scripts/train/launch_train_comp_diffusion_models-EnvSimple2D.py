...
network_config_l = [
    OrderedDict(guide_mode__ = "default",
                drop_context__ = False,
                len_ovlp_cd__ = 4,),
...
for single_experiment_params in single_experiment_params_l:
    ...
    launcher.add_experiment(
        generative_model_class__="CompDiffusionModel",
        **single_experiment_params,
        ...
        clip_grad=True,
        use_ema=True,
        summary_class="SummaryCompDiffuser",
