...
from torch_robotics.environments.pb_diff_envs.utils.save_utils import save_scatter_fig

class RandCuboidGroup(AbstractEnv):
    def __init__(self, env_list_name:str, dataset_name:str, num_groups, num_voxels, 
