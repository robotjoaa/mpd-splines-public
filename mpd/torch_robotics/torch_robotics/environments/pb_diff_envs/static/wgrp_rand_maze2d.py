...
from pb_diff_envs.static.rand_maze2d_env import RandMaze2DEnv
from pb_diff_envs.rand_rec_group import RandRectangleGroup
...
import mpd.datasets.pb_diff_datasets.utils as utils
...
class Maze2DRandRecGroupList : 
    ...
    def __init__(self, robot_env, num_groups, num_walls, 
        ...
        assert self.robot_env == RandMaze2DEnv
        ...
        if self.robot_env == RandMaze2DEnv :
        ...
        utils.print_color(f'robot_collision_eps: {c_eps}')
