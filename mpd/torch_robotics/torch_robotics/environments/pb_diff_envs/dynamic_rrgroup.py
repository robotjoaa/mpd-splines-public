...
from torch_robotics.environments.dynamic_extension.moving_primitives import LinearTrajectory
...
class DynamicRectangleWall(AbsDynamicWall):
    ...
    def __init__(self, center: np.ndarray, hExt: np.ndarray, 
                 trajectory: LinearTrajectory) -> None:
        # RectangleWall.__init__(self, center, hExt)
        self.item = MultiBoxField(center=center, hExt)
